...
namespace CS311B_DATABASE2024
{
    public partial class frmLogin : Form
    {
        ...
        //create login object using the class1
        Class1 login = new Class1("127.0.0.1", "cs311b2024", "wendel", "pastoral");
        private void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            if (errorcount == 0)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Incorrect account information or account is inactive", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch(Exception ex)  
                {
